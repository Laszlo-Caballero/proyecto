...
class Header(Frame):
    def __init__(self, root, Nombre, sede, *args, **kwargs):
        ...
        self.lblSede = Label(self, text=f"Se encuentra en el cajero de {sede}", background="#003399", foreground="white", font=self.FontDmi)
        self.lblSede.pack(side="left")
